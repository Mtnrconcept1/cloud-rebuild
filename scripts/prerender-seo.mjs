...
const PUBLIC_SEO_PAGES = [
  ...
  {
    path: "/restaurants-pres/victoria-hall-geneve",
    title: "Où manger près de Victoria Hall, Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de Victoria Hall à Genève avant ou après votre sortie ou événement sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/palexpo-geneve",
    title: "Où manger près de Palexpo, Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de Palexpo à Genève avant ou après votre salon ou événement sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/grand-theatre-de-geneve",
    title: "Où manger près du Grand Théâtre, Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité du Grand Théâtre à Genève avant ou après votre spectacle sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/stade-de-geneve",
    title: "Où manger près du Stade de Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité du Stade de Genève avant ou après votre match sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/theatre-de-beaulieu-lausanne",
    title: "Où manger près du Théâtre de Beaulieu, Lausanne | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité du Théâtre de Beaulieu à Lausanne avant ou après votre spectacle sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/dock-desk-nyon",
    title: "Où manger près de Dock Desk, Nyon | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de Dock Desk à Nyon avant ou après votre sortie sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/salle-del-castillo-vevey",
    title: "Où manger près de la Salle del Castillo, Vevey | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de la Salle del Castillo à Vevey sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/auditorium-stravinski-montreux",
    title: "Où manger près de l'Auditorium Stravinski, Montreux | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de l'Auditorium Stravinski à Montreux sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/equilibre-fribourg",
    title: "Où manger près d'Équilibre, Fribourg | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité d'Équilibre à Fribourg sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/theatre-du-passage-neuchatel",
    title: "Où manger près du Théâtre du Passage, Neuchâtel | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité du Théâtre du Passage à Neuchâtel sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/salle-du-faubourg-geneve",
    title: "Où manger près de la Salle du Faubourg, Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de la Salle du Faubourg à Genève sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
    path: "/restaurants-pres/alhambra-geneve",
    title: "Où manger près de l'Alhambra, Genève | TOK",
    description: "Réservez un restaurant ou trouvez une table à proximité de l'Alhambra à Genève sur TOK.",
    priority: "0.8",
    changefreq: "weekly",
  },
  {
