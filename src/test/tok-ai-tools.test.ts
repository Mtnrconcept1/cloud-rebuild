...
describe("TOK AI tools foundation", () => {
  ...
  it("keeps interactive photo generation inside Supabase Edge timeout budgets", () => {
    ...
    expect(source).toContain("const shouldUseFastInteractiveGeneration = !sourceImagePresent && USE_FAST_INTERACTIVE_IMAGE");
    expect(source).not.toContain("const shouldUseFastInteractiveEdit = sourceImagePresent || USE_FAST_INTERACTIVE_IMAGE");
