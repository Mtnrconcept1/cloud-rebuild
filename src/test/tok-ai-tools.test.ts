...
describe("TOK AI tools foundation", () => {
  ...
  it("keeps interactive photo generation inside Supabase Edge timeout budgets", () => {
    ...
    expect(source).toContain("photographie culinaire de studio professionnelle");
    expect(source).toContain("eclairage softbox premium");
    expect(source).toContain("profondeur de champ douce");
    expect(source).toContain("Renforce les formes, volumes, contours");
    expect(source).toContain("Nettoie tous les elements parasites");
