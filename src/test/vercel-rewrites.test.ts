...
describe("vercel config", () => {
  ...
  it("limits SPA rewrites to private application surfaces so unknown public URLs stay 404", () => {
    ...
    const privateSurfacePattern = "/:surface(admin|dashboard|courier|commercial|profil|memoire-tok|notifications|commandes|commande|reservations|mon-espace|compte|espace-client|mes-avis|points-cadeau|panier|auth|oauth|espaces|r)";
