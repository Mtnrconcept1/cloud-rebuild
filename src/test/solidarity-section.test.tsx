...
describe("SolidaritySection", () => {
  it("shows the Miamz image, impact counters, progress and next goal", () => {
    const { container } = render(<SolidaritySection donatedPoints={6939} />);
    ...
    expect(screen.getByText(/6 repas/i)).toBeInTheDocument();
    ...
    expect(progress).toHaveAttribute("aria-valuenow", "6939");
