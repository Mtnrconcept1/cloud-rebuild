...
function getSignupValidationError(
  ...
  if (role === "restaurateur") {
    ...
    if (!onboardingChoices?.launchPackId)
      return "Choisissez un pack de lancement.";
...
function appendPrivilegedSignupDraftFormData(input: {
  ...
  input.formData.append(
    ...
    input.role === "restaurateur"
      ? input.onboardingChoices?.launchPackId || ""
      : "",
  );
  input.formData.append(
            ...
            submittedRole === "courier"
              ...
              : submittedRole === "restaurateur"
                ? {
                    ...
                    selected_launch_pack_id:
                      submittedOnboardingChoices.launchPackId,
          ...
          {forgotPassword ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {isClientSignup ? (
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="client-gender">Genre</Label>
                    <Select
                    ...
                    <p className="text-xs text-muted-foreground">
                      Optionnel, modifiable depuis le profil, et utilisé pour
                      éviter des campagnes sponsorisées moins pertinentes.
                    </p>
                  </div>
                </div>
              ) : null}
                ...
                <div className="space-y-4 rounded-2xl border bg-card/60 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">
                        Pack de lancement et abonnement
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Ces choix sont joints au dossier. Le paiement sera
                        demandé depuis le dashboard avant la validation finale
                  ...
                  <div className="space-y-3">
                    ...
                    {launchPacksLoading ? (
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className="block pt-1 text-xs text-muted-foreground">
                                {pack.description ||
                                  "Accompagnement de lancement TOK."}
                              </span>
                      ...
                      <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-4 text-sm text-destructive">
                        Aucun pack actif n'est disponible. Contactez TOK avant
                        de poursuivre.
                      </div>
                    )}
                  </div>
                  ...
                  {selectedLaunchPackId && selectedSubscriptionPlan ? (
                    <div className="rounded-xl border bg-background p-3 text-sm">
                      <p className="font-medium">
                        Total initial à régler après création du dossier
                      </p>
                      <p className="pt-1 text-muted-foreground">
                        Pack choisi + {formatChf(selectedSubscriptionPrice)} /
                        mois.
                      </p>
                    </div>
                  ) : null}
