...
const quickPoints = [
  ...
  "Seules les réservations acquises par TOK et réellement honorées sont facturees ; les canaux propres, annulations, no-shows, remboursements et demonstrations valent CHF 0.",
  "Le frais de réservation est plafonné a 7 % du chiffre d'affaires attribué à la table.",
...
const sections = [
  {
    ...
    body: [
      "Les présentes Conditions Generales Restaurateurs regissent les relations contractuelles entre TOK et les etablissements partenaires, exploitants, societes, independants ou representants autorises qui utilisent la plateforme TOK pour gérer leur presence, leurs commandes, réservations, offres, campagnes, contenus, outils marketing, outils IA, factures, statistiques ou services associes.",
      "L'inscription, la demande d'onboarding, l'acces au dashboard restaurateur, l'utilisation d'un service TOK ou la validation d'une offre commerciale implique l'acceptation pleine et entiere des présentes conditions, sous reserve de tout contrat écrit specifique signe entre les parties.",
      "Ces conditions completent les Conditions Generales d'Utilisation, la Politique de confidentialité, la Politique cookies, les conditions tarifaires, les conditions de paiement et les règles operationnelles affichees dans le dashboard.",
    ],
  },
  {
    title: "2. Definitions",
    body: [
      "Réservation acquise par TOK désigne une réservation dont la première source vérifiable est la marketplace TOK. La source est attribuée et scellée côté serveur à la création.",
      "Canal propre désigne le site du restaurant, un QR code attribué, Instagram, Google ou un fichier client légitime du restaurateur. Le traitement technique par TOK ne transforme pas un canal propre en acquisition TOK.",
      "Réservation honorée désigne une table effectivement accueillie, declaree par une personne autorisée du restaurant avec le chiffre d'affaires attribué. Une annulation, un no-show, un remboursement ou une demonstration n'est jamais honorée au sens tarifaire.",
      "Base commissionnable d'une commande exclut les pourboires, la livraison refacturee et les autres coûts explicitement identifies comme debours ou refacturations.",
      "Revenu TOK réellement encaissé désigne les montants définitivement reçus par TOK, hors TVA, remboursements, pourboires, livraison et coûts refactures.",
    ],
  },
  {
    title: "3. Services fournis par TOK",
    body: [
      "TOK met a disposition des outils permettant au restaurateur de presenter son etablissement, publier des informations, recevoir des réservations, vendre des offres, gérer des commandes, animer son actualite, lancer des campagnes, suivre des statistiques, utiliser des outils IA, consulter ses factures et dialoguer avec le support.",
      "TOK peut ajouter, modifier, limiter, suspendre ou retirer un service a tout moment, notamment pour des raisons de sécurité, conformite, maintenance, test, disponibilite locale, bug, evolution commerciale ou decision administrative.",
  ...
  {
    title: "4. Onboarding, vérification et acces restaurateur",
    body: [
  ...
  {
    title: "6. Hygiène, allergènes, sécurité alimentaire et conformite",
    body: [
      "Le restaurateur demeure seul responsable de la preparation, conservation, disponibilite, hygiene, qualite, conformite, temperature, emballage, traçabilite, informations allergènes et sécurité alimentaire des produits qu'il propose.",
      "Les prix, descriptions, photos et contenus IA ne remplacent jamais l'obligation du restaurateur de verifier les ingrédients, allergènes, contaminations croisees, mentions obligatoires, restrictions alimentaires et informations pouvant influencer la decision du client.",
      "Le restaurateur doit disposer des autorisations administratives, assurances, licences, controles et obligations applicables a son activite. TOK peut demander des justificatifs lorsqu'un risque client, sanitaire, reputational ou légal est identifie.",
    ],
  },
  {
    title: "7. Commissions et tarification Fair Growth",
    body: [
      "Les abonnements mensuels sont : Starter CHF 69, Business CHF 129, Premium CHF 199 et Elite CHF 499. Une période annuelle fournit douze mois de service et est facturée onze mensualites, soit respectivement CHF 759, CHF 1'419, CHF 2'189 et CHF 5'489.",
      ...
      "Elite inclut trois etablissements. Chaque etablissement additionnel est facturé CHF 149 par mois. Les autres plans couvrent un etablissement sauf accord écrit.",
      "Les prix sont enregistrés sous une version tarifaire immuable lors de la souscription ou de la transaction. Une evolution future ne modifie pas retroactivement les operations deja acquises.",
    ],
  },
  {
    title: "8. Facturation, reversements, taxes et repartition contractuelle",
    body: [
      "Sur chaque frais de réservation effectivement encaissé, 90 % reviennent a TOK et 10 % au développeur. Les frais sont annules ou credites lorsqu'une réservation devient non eligible avant cloture.",
      "Sur une commande, 1 % de la base commissionnable revient au développeur ; TOK conserve le solde de la commission du plan et le restaurant le solde de la base, avec 100 % des pourboires. La cle 90 % restaurant, 9 % TOK et 1 % développeur constitue la reference maximale a 10 % ; les taux Fair Growth inferieurs reduisent la part TOK au benefice du restaurant.",
      "Sur les abonnements, publicités et modules, le développeur recoit 10 % du revenu TOK réellement encaissé, hors TVA, remboursements, pourboires, livraison et coûts refactures.",
      "Pour les commandes marketplace, TOK absorbe les coûts Stripe et Connect sur sa propre part afin que le restaurant recoive la part Fair Growth annoncee. Les frais publics des prestataires peuvent evoluer ; leur snapshot et le moyen réellement utilise sont conserves avec la transaction.",
  ...
  },
  {
    ...
    body: [
      ...
      "Il est en revanche interdit de modifier, masquer ou falsifier la source d'une réservation deja initiee et attribuée a TOK, de demander au client de la recreer sur un autre canal, ou de declarer un faux no-show afin d'éviter un frais légitime.",
      "TOK conserve une piste d'audit de la source, des jetons de canal, du statut, du chiffre d'affaires attribué, du plafond et de la version tarifaire. Toute correction exceptionnelle exige un traitement administratif trace.",
    ],
  },
  {
    ...
    body: [
      ...
      "Les réservations du site du restaurant, QR code, Instagram, Google et fichier client sont gratuites. Les annulations, no-shows, remboursements et environnements de demonstration sont egalement gratuits.",
      "Une réservation honorée est verrouillee contre une requalification ordinaire en no-show. Les remboursements et contestations sont rapproches de la facturation avant cloture ou traites par avoir audite.",
    ],
  },
  {
    title: "11. Commandes, paiements, pourboires et modules",
    body: [
      "La commission marketplace s'applique uniquement a la base commissionnable. Les pourboires sont reverses à 100 % au restaurant et ne servent jamais de base à la commission TOK ou développeur.",
      ...
      "Les modules proposés sur demande sont : No-Show Shield CHF 39/mois ; Marketing Autopilot IA CHF 79/mois ; Margin & Waste Pilot CHF 59/mois ; Réputation IA CHF 29/mois. Le Receptionniste téléphonique IA (CHF 49/mois plus CHF 1.50 par réservation réussie), Direct Order Saver (CHF 149/mois plus 1,5 %) et les cartes-cadeaux et experiences (3 % plus coût de paiement) restent des offres pilote soumises a validation technique et contractuelle.",
      "Une demande depuis le dashboard n'active pas un module et n'autorisé aucun debit. TOK et le restaurateur confirment le périmètre, les prerequis, le prix, la date de debut et les conditions de facturation avant toute activation payante.",
  ...
  },
  {
    ...
    body: [
      ...
      "Une offre doit correspondre a une disponibilite reelle. Les offres anti-gaspillage, ventes flash, offres progressives ou offres du jour ne doivent pas tromper le client sur la quantite, la fraicheur, la remise, la date limité ou les conditions de retrait.",
      "TOK peut retirer ou suspendre une offre en cas d'erreur, abus, rupture repetee, prix incoherent, réclamations nombreuses, risque légal ou non-respect des règles de publication.",
    ],
  },
  {
    title: "13. Actualites, avis, commentaires et signalements",
    body: [
      "Les actualites, avis, commentaires, vidéos, photos, reposts et reponses restaurateur doivent refleter des informations authentiques, licites et respectueuses.",
      "Les avis publies doivent correspondre a une experience reelle. TOK peut masquer, moderer ou supprimer tout contenu faux, trompeur, injurieux, diffamatoire, haineux, frauduleux, illicite, publicitaire abusif ou contraire aux règles de la plateforme.",
  ...
  },
  {
    ...
    body: [
      ...
      "Le restaurateur garantit que ses publicités, promotions, prix, réductions, photos et claims commerciaux sont exacts, non trompeurs et conformes àux règles applicables a la publicité et a la concurrence loyale.",
  ...
  },
  {
    ...
    body: [
      "Les outils d'intelligence artificielle proposés par TOK sont fournis a titre d'assistance: amelioration de texte, visuels, retouche photo, analyse marketing, suggestions, CRM, templates, modération ou recommandations operationnelles.",
      "Le restaurateur demeure seul responsable des contenus qu'il publie, valide ou reutilise, y compris lorsqu'ils sont generes, retouches, resumes ou proposés par IA.",
      "Le restaurateur garantit disposer de l'ensemble des droits nécessaires sur les contenus transmis a TOK: photographies, vidéos, logos, marques, textes, cartes de visite, cartes de restaurant, menus, visuels existants et elements graphiques.",
      "TOK ne garantit ni l'exactitude absolue, ni l'absence d'erreur, ni les performances commerciales des contenus generes. Le restaurateur doit verifier prix, horaires, allergènes, ingrédients, visuels, droits de tiers et mentions legales avant publication.",
  ...
  },
  {
    ...
    body: [
      "Le restaurateur conserve la propriété des contenus qu'il transmet a TOK, sous reserve des droits de tiers et des licences applicables.",
      "Le restaurateur accorde a TOK une licence non exclusive, mondiale, gratuite, transferable aux prestataires techniques nécessaires et valable pendant la duree du partenariat pour afficher, heberger, adapter techniquement, optimiser, promouvoir, analyser, moderer et diffuser les contenus dans le cadre des services TOK.",
  ...
  },
  {
    ...
    body: [
      ...
      "Les exports CRM, CSV, XLS, factures, listes de clients, historiques et profils de vente doivent être conserves de maniere securisee, accessibles uniquement aux personnes autorisees et supprimes lorsqu'ils ne sont plus nécessaires.",
      ...
      "TOK peut imposer des mesures de sécurité complementaires, notamment authentification forte, limitation d'export, journalisation, quotas, vérification d'identite ou blocage en cas de risque.",
    ],
  },
  {
    ...
    body: [
      ...
      "Cette presomption peut être renversee par tout moyen de preuve admissible. Chaque partie doit conserver les elements utiles a ses réclamations, notamment tickets, justificatifs, photos, historiques internes et preuves de service.",
  ...
  },
  {
    ...
    body: [
      ...
      "Le restaurateur accepte de fournir tout element utile: tickets de caisse, justificatifs de preparation, preuves de service, photographies, historiques internes, temoignages et enregistrements de videosurveillance lorsque leur utilisation est legalement autorisée.",
      "Sont notamment frauduleux: fausses réservations, faux avis, demandes abusives de remboursement, fausses declarations, paiement frauduleux, manipulation Miamz, création de comptes fictifs, auto-commandes artificielles, abus de campagnes ou tentative d'obtenir gratuitement un produit ou service consomme.",
  ...
  },
  {
    ...
    body: [
      "TOK met en oeuvre des moyens raisonnables afin d'assurer la disponibilite et la sécurité de la plateforme, sans garantir l'absence totale d'interruption, d'erreur, de bug, de perte temporaire, de lenteur ou d'indisponibilite.",
      ...
      "TOK peut realiser des maintenances, mises a jour, migrations, tests, corrections de sécurité ou modifications de service avec ou sans notification prealable selon l'urgence.",
    ],
  },
  {
    title: "21. Limitation de responsabilite",
    body: [
      "TOK agit comme plateforme technologique d'intermediation. TOK ne saurait etre tenu responsable des pertes d'exploitation, pertes de clientele, pertes de benefices, erreurs du restaurateur, informations publiées par le restaurateur, defaillances de prestataires tiers ou interruptions de réseaux externes.",
  ...
  },
  {
    ...
    body: [
      "Le restaurateur peut demander depuis Mon compte/Facturation ou au support la pause d'un module ou la résiliation de son abonnement. Toute date d'effet est confirmee par TOK. La pause arrete l'usage et les facturations futures du module selon cette confirmation, sans annuler les sommes deja dues.",
      "Une résiliation mensuelle prend effet à la fin de la période en cours. Une période annuelle est engagée jusqu’à son échéance et ne donne pas lieu à remboursement anticipé, sauf accord écrit ou droit impératif. Les modules optionnels peuvent etre résiliés separement de l'abonnement principal.",
      "TOK peut suspendre ou resilier un compte en cas de fraude, non-paiement, violation des présentes conditions, utilisation abusive, atteinte à la sécurité, contournement de plateforme, non-cooperation, risque légal, réclamations graves ou atteinte a l'image de TOK.",
      "Sauf fraude manifeste, urgence, risque de sécurité, risque client ou obligation legale, TOK peut accorder un delai raisonnable permettant au restaurateur de regulariser sa situation.",
      "La résiliation n'efface pas les sommes dues, obligations de confidentialité, obligations de preuve, droits de recouvrement, obligations de conservation comptable ou responsabilites nees avant la fin du partenariat.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "TOK peut modifier les présentes conditions afin de tenir compte des evolutions legales, techniques, commerciales, fiscales, securitaires ou des nouveaux services proposés.",
      "Les modifications substantielles seront notifiees aux restaurateurs avant leur entree en vigueur par email, notification, dashboard ou tout moyen approprie. La poursuite de l'utilisation de la plateforme après entree en vigueur vaut acceptation des conditions modifiees.",
    ],
  },
  {
    title: "25. Droit applicable et juridiction",
    body: [
      "Les présentes conditions sont regies par le droit suisse.",
  ...
  },
  {
    ...
    body: [
      ...
      "Le restaurateur peut autoriser ou refuser un partenaire par restaurant lorsque la fonctionnalite est disponible. Cette autorisation peut être limitée par scopes, quotas, période, finalite, volume de réservations, taille de table, disponibilités, webhooks ou tout autre paramètre affiche dans le dashboard.",
      "Les données accessibles via TOK Connect restent limitees au périmètre autorisé: informations restaurant, menu, disponibilités, réservation, performance agrégée, credits ou previews de campagne selon les scopes accordes. Les données de paiement sensibles, secrets serveur et informations non nécessaires ne doivent pas être transmis au partenaire.",
      "Les réservations creees par TOK Connect engagent le restaurant uniquement lorsqu'elles sont confirmées selon le parcours TOK, les disponibilités réelles, les règles de service et les limites accordees au partenaire. Le restaurateur doit maintenir ses horaires, tables, capacités et restrictions a jour afin d'éviter des confirmations incorrectes.",
      ...
      "Le restaurateur doit choisir des partenaires fiables, verifier la finalite de l'integration, informer TOK de tout usage suspect et retirer l'autorisation lorsqu'elle n'est plus necessaire. TOK peut suspendre ou revoquer un partenaire en cas de risque, abus, faille de sécurité, non-conformite ou demande légitime.",
    ],
  },
];
...
export default function ConditionsRestaurateurs() {
  useSeoMeta({
    ...
    description: "Cadre contractuel applicable àux établissements partenaires utilisant les services TOK.",
