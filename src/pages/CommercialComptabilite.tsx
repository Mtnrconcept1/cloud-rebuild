            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground md:text-base">
                  Consultez les commissions, le fixe, les bonus et les restaurants signés. Tous les montants sont calculés côté serveur et aucun bonus, prime ou ajustement ne peut être ajouté depuis ce tableau.
                </p>
              </div>
