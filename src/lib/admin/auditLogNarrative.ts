...
const FUNCTION_PURPOSE: Record<string, string> = {
  ...
  "cloudprinter-webhook": "la réception sécurisée des événements d’impression Cloudprinter",
  ...
  "print-quote": "le calcul d’un devis d’impression",
  "print-reconcile": "la réconciliation des commandes d’impression avec le fournisseur",
