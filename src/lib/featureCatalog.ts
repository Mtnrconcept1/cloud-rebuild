...
export const FEATURE_DEFINITIONS: FeatureFlagDefinition[] = [
  ...
  },
  {
    ...
    label: "TOK Connect API",
    description: "Active l'API REST versionnee, OAuth client-credentials et les quotas partenaires.",
    defaultEnabled: true,
    group: "client_features",
    dependsOn: ["tok-connect"],
  },
  {
    name: "tok-connect-mcp",
    label: "TOK Connect MCP",
    description: "Active le serveur MCP prudent pour tools, resources et prompts sûrs.",
    defaultEnabled: true,
    group: "client_features",
    dependsOn: ["tok-connect"],
  },
  {
    name: "tok-connect-webhooks",
    label: "TOK Connect Webhooks",
    description: "Active les webhooks sortants signes pour partenaires approuves.",
    defaultEnabled: true,
    group: "client_features",
    dependsOn: ["tok-connect"],
  },
  {
    name: "tok-connect-autopilot",
    label: "TOK Connect Autopilot",
    description: "Garde les actions autonomes hors production v1.",
    defaultEnabled: false,
    group: "client_features",
    dependsOn: ["tok-connect"],
  },
  ...
  },
  {
    ...
    description: "Expose le pilotage des réservations et du service du restaurant.",
    defaultEnabled: true,
    group: "restaurant_dashboard",
    dependsOn: ["dashboard-restaurateur"],
  ...
  {
    name: "dashboard-tok-connect",
    label: "Dashboard: TOK Connect",
    description: "Expose les consentements partenaires TOK Connect par restaurant.",
    defaultEnabled: true,
    group: "restaurant_dashboard",
    dependsOn: ["dashboard-restaurateur", "tok-connect"],
    routeTargets: ["/dashboard/tok-connect"],
  },
  {
  ...
  {
    name: "admin-tok-connect",
    label: "Admin: TOK Connect",
    description: "Expose la supervision des partenaires, scopes, quotas et webhooks TOK Connect.",
    defaultEnabled: true,
    group: "admin_tools",
    dependsOn: ["tok-connect"],
    routeTargets: ["/admin/tok-connect"],
  },
  {
