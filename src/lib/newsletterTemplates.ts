...
export const NEWSLETTER_TEMPLATES: NewsletterTemplate[] = [
  {
    ...
    body: `Bonjour, voici une sélection claire de restaurants, tables et bons plans adaptés à vos habitudes récentes. Nous mettons en avant des disponibilités utiles, sans pression, pour vous aider a choisir plus vite votre prochain repas. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
  ...
  },
  {
    ...
    body: `Votre niveau Gold débloque des avantages utiles pour vos prochaines commandes et réservations: support prioritaire, créneaux premium quand ils sont disponibles et bonus Miamz renforces. Consultez votre espace fidélité pour suivre la progression. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
    channels: { in_app: true, email: true, push: false },
  ...
  },
  {
    ...
    preview: "Nouveautes produit utiles pour commander et réserver.",
  ...
  },
  {
    ...
    body: `Quand vous preferez rester chez vous, Tok peut vous aider a choisir des restaurants avec des informations de livraison lisibles. Voici des options pertinentes selon vos favoris et disponibilités locales. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
    channels: { in_app: true, email: true, push: false },
  ...
  },
  {
    ...
    body: `Certains restaurants ouvrent ponctuellement des menus chefs, tables speciales ou experiences limitées. Cette sélection vous signale les opportunités disponibles avec des informations simples et vérifiables. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
    channels: { in_app: true, email: true, push: false },
  ...
  },
  {
    ...
    body: `Cette sélection est pensée pour les jours de bureau: restaurants proches, service rapide et réservations ou commandes compatibles avec une pause courte. Elle vous aide a décider sans multiplier les recherches. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
    channels: { in_app: true, email: true, push: false },
  ...
  },
  {
    ...
    preview: "Créneaux et lieux pratiques apres le travail.",
    body: `Pour organiser une sortie apres le travail, voici des restaurants avec horaires pratiques, ambiance adaptée et disponibilités visibles. La sélection limite les choix pour faciliter la decision. ${preferenceFooter}`,
    category: "marketing",
    targetRoles: ["client"],
    channels: { in_app: true, email: true, push: false },
    recommendedSendHour: 15,
