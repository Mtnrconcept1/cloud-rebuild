...
export default function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative overflow-hidden border-b">
      <div
        className="absolute inset-0 bg-[url('/fond.jpg')] bg-cover bg-center md:bg-[url('/fond3.png')] blur-[2px] will-change-transform"
        style={{ transform: "translateY(calc(var(--scroll-y, 0px) * 0.4))" }}
        aria-hidden="true"
      />
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] md:w-[700px] md:h-[700px] bg-white/60 blur-[30px] rounded-full pointer-events-none will-change-transform"
