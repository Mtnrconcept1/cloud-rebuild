...
export default function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative overflow-hidden border-b">
      <div
        className="absolute inset-0 bg-[url('/fond3.png')] bg-contain bg-top bg-no-repeat md:bg-cover md:bg-center md:bg-[url('/fond4.png')] blur-[2px] will-change-transform"
