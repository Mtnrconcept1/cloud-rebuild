...
export default function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative overflow-hidden border-b">
      ...
      />
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] md:w-[700px] md:h-[700px] bg-white/40 blur-[30px] rounded-full pointer-events-none will-change-transform"
