        ...
        <div className="container py-12 md:py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            <div className="col-span-2 md:col-span-1 space-y-4">
              <img src={logoSrc} alt="Tok" className="h-10 w-auto object-contain" decoding="async" height={394} width={512} />
              ...
              <div className="flex gap-3">
                <a href="#" aria-label="Facebook TOK" className="w-9 h-9 rounded-full bg-secondary flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </a>
                <a href="#" aria-label="Instagram TOK" className="w-9 h-9 rounded-full bg-secondary flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
                ...
                <a href="#" aria-label="X TOK" className="w-9 h-9 rounded-full bg-secondary flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
            ...
            <div className="space-y-3">
              <p className="font-display font-bold text-sm">Découvrir</p>
            ...
            <div className="space-y-3">
              <p className="font-display font-bold text-sm">Informations</p>
              <nav className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              <p className="font-display font-bold text-sm">Restaurateur</p>
              <nav className="flex flex-col gap-2 text-sm text-muted-foreground">
