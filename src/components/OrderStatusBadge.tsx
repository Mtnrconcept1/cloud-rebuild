...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  ready: { label: "Prête", className: "bg-teal-100 text-teal-800 border-teal-200 dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-700" },
  ready_for_pickup: { label: "Prête", className: "bg-teal-100 text-teal-800 border-teal-200 dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-700" },
