...
export default function ChefTableSlotDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-hidden border-amber-200 bg-white p-0 shadow-[0_40px_120px_-48px_rgba(120,53,15,0.55)] sm:max-w-[780px] sm:rounded-[32px]">
        <DialogHeader className="border-b border-amber-200/70 bg-gradient-to-br from-stone-950 via-neutral-900 to-amber-950 px-6 pb-6 pt-6 text-left">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            {remainingPortions != null ? (
              <div className="rounded-full border border-amber-300/35 bg-amber-500/14 px-3 py-1 text-xs font-medium text-amber-100">
          ...
          <DialogDescription className="mt-2 max-w-2xl text-sm leading-6 text-white/72">
        ...
        <div className="grid gap-6 px-6 pb-6 pt-5 lg:grid-cols-[minmax(0,1.15fr)_280px]">
          <div className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-semibold">Date de reservation</label>
              <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="h-12 w-full justify-start rounded-2xl border-amber-200 text-left font-normal">
            ...
            {hasAnySlot ? (
              <div className="space-y-4 rounded-[28px] border border-amber-100 bg-gradient-to-br from-amber-50 via-white to-orange-50/70 p-4">
          ...
          <div className="space-y-4">
            <div className="rounded-[28px] border border-amber-200 bg-amber-50/80 p-5 shadow-sm">
              ...
              <div className="mt-4 flex items-center justify-between rounded-[24px] bg-white p-2 shadow-sm">
                <Button
                  type="button"
                  variant="ghost"
                  size="icon"
                ...
                <div className="text-center">
                  <p className="font-display text-4xl font-bold text-foreground">{partySize}</p>
            ...
            <div className="rounded-[28px] bg-stone-950 p-5 text-white shadow-[0_28px_90px_-46px_rgba(15,23,42,0.92)]">
              ...
              <div className="mt-4 rounded-2xl border border-white/10 bg-white/6 p-4">
                ...
                <div className="mt-3 flex items-end justify-between gap-4">
                  ...
                  <div className="rounded-2xl border border-amber-300/30 bg-amber-500/14 px-3 py-2 text-right">
              ...
              <div className="mt-4 flex items-start gap-2 rounded-2xl border border-white/10 bg-white/6 px-3 py-3 text-xs text-white/70">
        ...
        <div className="flex flex-col-reverse gap-2 border-t border-amber-100 px-6 py-4 sm:flex-row sm:justify-end">
