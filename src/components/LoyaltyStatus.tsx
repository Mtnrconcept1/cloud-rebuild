      ...
      <div className="relative z-10 space-y-4">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="link" className="min-h-[44px] justify-start p-0 text-xs font-semibold text-primary hover:text-[#c23700] dark:text-orange-200 dark:hover:text-orange-100">
