...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: "/dashboard/comparaison", label: "Comparaison", icon: Scale, feature: "performances" },
  ...
  },
  {
    title: "Marketing",
    items: [
      { to: "/dashboard/campagne-overview", label: "Campagnes", icon: Megaphone, feature: "campagnes-pub" },
      { to: "/dashboard/reseaux-sociaux", label: "Reseaux sociaux", icon: Share2, feature: "campagnes-pub" },
      { to: "/dashboard/campagnes", label: "Campagnes avancees", icon: Megaphone, feature: "campagnes-pub" },
    ],
  },
  {
    title: "Paiements",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/dashboard/offres", label: "Anti-gaspi", icon: Leaf, feature: "anti-gaspi" },
      { to: "/dashboard/ventes-flash", label: "Ventes flash", icon: Zap, feature: "ventes-flash" },
