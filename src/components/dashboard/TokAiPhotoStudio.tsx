        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_300px]">
            ...
            <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Ex. boîte de caviar, tacos poulet, salade..."
                />
              </div>
              <div className="space-y-2">
                <Label>Format</Label>
          ...
          <div className="rounded-xl border bg-background/80 p-4 text-sm text-muted-foreground">
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li className="flex gap-2"><CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-600" /> Interdiction de remplacer une boîte par un plat servi.</li>
