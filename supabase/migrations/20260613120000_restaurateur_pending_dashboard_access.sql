-- Keep restaurateur signups in the restaurateur surface while their dossier is reviewed.
-- The restaurant remains inactive/pending until admin approval; the frontend locks dashboard features.
...
INSERT INTO public.user_roles (user_id, role)
SELECT sa.user_id, 'restaurateur'::public.app_role
FROM public.signup_applications sa
WHERE sa.requested_role = 'restaurateur'
