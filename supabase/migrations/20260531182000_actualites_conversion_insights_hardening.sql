...
-- Keep attribution valid when a campaign is paused or has ended after the click,
-- as long as the original paid sponsored click happened during the attribution window.
