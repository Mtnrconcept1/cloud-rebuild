-- Fix ambiguous references between RETURNS TABLE output columns and table columns in the
-- privileged signup RPC used by the submit-signup-application Edge Function.
-- The previous function body used an unqualified `application_id` column inside
-- PL/pgSQL, which can be resolved ambiguously against the output column name.
