...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const baseMetadata = {
      ...
      miamz_delivery_discount_amount: pricing.miamzDeliveryDiscount,
      miamz_delivery_discount_percent: pricing.miamzDeliveryDiscountPercent,
      miamz_benefits_applied: pricing.miamzBenefitsApplied,
      miamz_points_multiplier: pricing.miamzPointsMultiplier,
